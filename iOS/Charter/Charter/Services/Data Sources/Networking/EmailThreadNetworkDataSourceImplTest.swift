...
class EmailThreadNetworkDataSourceImplTest: XCTestCase {
    ...
    func testGetThreads() {
        ...
        mockSession.assertionBlockForRequest = { request in
            ...
            XCTAssertEqual(request.URL?.absoluteString, "http://charter.ws:8080/charter/emails?sort_by=-date&page=1&pagesize=25&filter=%7BinReplyTo:null%7D")
