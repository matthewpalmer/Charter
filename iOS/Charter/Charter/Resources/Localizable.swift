...
//  Charter
//
//  Created by Francisco Amado on 17/03/16.
...
struct Localizable {
	struct Strings {
		...
		static let subject = NSLocalizedString("subject", tableName: "LocalizableStrings", comment: "")
		static let author = NSLocalizedString("author", tableName: "LocalizableStrings", comment: "")
		static let content = NSLocalizedString("content", tableName: "LocalizableStrings", comment: "")
	}
}